...
gecontroleerde tracks echt gedownload naar `./media/downloads`; daarnaast kan
de admin alle tracks vooraf controleren en downloaden. De image downloadt
niets blind tijdens het opstarten. Lokale bestanden blijven in `./media` staan.
